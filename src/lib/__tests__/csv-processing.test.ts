...
const TOO_MANY_COLUMNS_PATTERN = /too many columns/i;
const CELL_VALUE_EXCEEDS_PATTERN = /cell value exceeds maximum size/i;
...
describe("processCSVFile", () => {
  ...
  it("throws when exceeding configured column count", async () => {
    ...
    ).rejects.toThrow(TOO_MANY_COLUMNS_PATTERN);
  });
